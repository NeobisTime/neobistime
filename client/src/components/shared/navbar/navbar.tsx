      ...
      <div className="navbar__content">
        <ul className='navbar__list'>
          <NavLink to='/notifications' className="navbar__list-link" >
            <img src={notification} className="navbar__list-image navbar__list-image_filter" alt='icon' />
          ...
          <NavLink to='/' className="navbar__list-link" >
            <img src={admin} className="navbar__list-image navbar__list-image_filter" alt='icon' />
